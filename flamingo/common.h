...
static inline int parse_access(flamingo_t* flamingo, TSNode node, flamingo_val_t** val);
...
static inline int parse_function_declaration(flamingo_t* flamingo, TSNode node, bool is_class);
